...
import searchMapper from '../../json_mappers/wcs9/searchMapper';
...
export default {
    ...
    */
    ...
    getSearchResults: function(req,res){
        ...
        let path = constants.WCS_REST_URL+constants.WCS_STORE_ID+constants.WCS_PRODUCT_SEARCH_BY_KEYWORD+keyword+"?pageSize="+pageSize+"&pageNumber="+currentPage;
    ...
    keywordSuggestionsByTerm: function(req,res){
        ...
        let concatURL = constants.WCS_REST_URL+ constants.WCS_STORE_ID + constants.WCS_KEYWORD_SUGGESTION+term;
