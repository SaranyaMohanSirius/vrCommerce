...
export default {
   ...
   registration: function(req,res){
        ...
        let RegistrationUrl = constructUrl(constants.WCS_HOSTNAME_NOPORT,concatURL,true);
        let method ='POST';
        let messageData = req.body;
        let requestCall = constructRequestWithoutToken(RegistrationUrl,method,messageData);
